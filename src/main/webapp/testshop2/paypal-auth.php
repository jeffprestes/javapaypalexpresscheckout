...
define('ACCESS_TOKEN_ENDPOINT', 'https://www.sandbox.paypal.com/webapps/auth/protocol/openidconnect/v1/tokenservice');
define('PROFILE_ENDPOINT', 'https://www.sandbox.paypal.com/webapps/auth/protocol/openidconnect/v1/userinfo');
define('LOGOUT_ENDPOINT', 'https://www.sandbox.paypal.com/webapps/auth/protocol/openidconnect/v1/endsession');
define('VALIDATE_ENDPOINT', 'https://www.sandbox.paypal.com/webapps/auth/protocol/openidconnect/v1/checkid');

class PayPalAccess{
    private $key = 'AS1weBAIF3qm6IPUqt0GoY7QyhZzipNdjEgIlwfBUDhIx1gIcsWezcFz1cnU'; //clientID
    private $secret = 'EJCBxRDuUiteFeOmk0k7yDMsEiaz3uG3czVHnmkM_42cS33klQYuEVlY2srn';   
    private $scopes = 'profile email address phone https://uri.paypal.com/services/paypalattributes';                    //e.g. openid email profile https://uri.paypal.com/services/paypalattributes
    private $state;
    private $return_url = 'http://www.novatrix.com.br/clinicasys/lcp.php';
