    ...
    <body>
        <script>
            ...
            function concat(){
                ...
                document.getElementById("L_BILLINGAGREEMENTDESCRIPTION0").value = document.getElementById("L_BILLINGAGREEMENTDESCRIPTION0").value +" | Valor da Assinatura: R$ "+ document.getElementById("AMT_SIG").value+" | Periodicidade : "+periodo+" | Numero de pagamentos: "+ document.getElementById("BILLINGFREQUENCY").value; 
            }
        ...
        <form action='<c:out value="${pageContext.servletContext.contextPath}" />/ExpressCheckoutController' method="POST">
            <table>
                ...
                <tr>
                    <td>Usuario (USER): </td>
                    <td>
                        <input type="text" value="test_receiver_api1.paypal.com" size="60" name="USER" id="USER" />
                    </td>
                </tr>
                <tr>
                    <td>Senha (PWD): </td>
                    <td>
                        <input type="text" value="1390483509" size="60" name="PWD" id="PWD" />
                    </td>
                </tr>
                <tr>
                    <td>Assinatura (SIGNATURE): </td>
                    <td>
                        <input type="text" value="AxsydGcjKwrQPpQn0mX3dm-eVkpbAxRvIWDS5F42-iy5C.59vYMO2gZi" size="60" name="SIGNATURE" id="SIGNATURE" />
                    </td>
                </tr>
                <tr>
                    <td>
