...
**/
            ...
            out.print("METHOD=CallbackResponse&OFFERINSURANCEOPTION=false&L_SHIPPINGOPTIONLABEL0=" + valor.getNomeEntrega1() + "&L_SHIPPINGOPTIONAMOUNT0=" + (valor.getTotal()+2) +"&L_SHIPPINGOPTIONLABEL1=" + valor.getNomeEntrega2() + "&L_SHIPPINGOPTIONAMOUNT1=" + valor.getTotal() + "&L_SHIPPINGOPTIONLABEL2=PAC&L_SHIPPINGOPTIONAMOUNT2=6.00&L_SHIPPINGOPTIONISDEFAULT0=true");
            }
