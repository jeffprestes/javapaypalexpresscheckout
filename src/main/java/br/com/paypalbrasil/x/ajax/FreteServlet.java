...
**/
            ...
            if(item2.getAltura()== 0){
                ...
                out.print("METHOD=CallbackResponse&OFFERINSURANCEOPTION=false&L_SHIPPINGOPTIONLABEL0=" + valor.getNomeEntrega() + "&L_SHIPPINGOPTIONAMOUNT0=" + item.getValorEntrega() + "&L_TAXAMT0=2.20&L_INSURANCEAMOUNT0=1.51&L_SHIPPINGOPTIONLABEL1=PAC&L_SHIPPINGOPTIONAMOUNT1=4.00&L_TAXAMT1=2.20&L_INSURANCEAMOUNT1=1.51&L_SHIPPINGOPTIONISDEFAULT0=true");
            }else{
            ...
            out.print("METHOD=CallbackResponse&OFFERINSURANCEOPTION=false&L_SHIPPINGOPTIONLABEL0=" + valor.getNomeEntrega() + "&L_SHIPPINGOPTIONAMOUNT0=" + valor.getTotal() + "&L_TAXAMT0=2.20&L_INSURANCEAMOUNT0=1.51&L_SHIPPINGOPTIONLABEL1=PAC&L_SHIPPINGOPTIONAMOUNT1=4.00&L_TAXAMT1=2.20&L_INSURANCEAMOUNT1=1.51&L_SHIPPINGOPTIONISDEFAULT0=true");
            }
