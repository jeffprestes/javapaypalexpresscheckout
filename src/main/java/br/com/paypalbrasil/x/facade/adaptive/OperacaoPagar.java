...
public class OperacaoPagar {
    ...
    /**
     * Operacao para execucao da acao de pagamento do Adaptive Payments da PayPal
     * @param credenciais Credenciais da plataforma
     * @param pra Parametros da Requisição (valor, produto, etc)
     * @param recebedores Recebedores da transação quando há pararalles ou splitpayments
     * @param respPgtoTaxa No caso de parallels ou splitpayment define quem é o responsável pelo pagamento da taxa
     */
