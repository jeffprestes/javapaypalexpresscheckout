...
public class WSFretesPayPal {
	...
	/**
	 * Cria uma instância de SOAPMessage para ser enviada para o serviço PayPal
	 * Frete Fácil para o cálculo do frete.
	 * 
	 * @param cepOrigem
	 * @param cepDestino
	 * @param largura
	 ...
	 *            O CEP de destino
	 * @param largura
	 *            A largura da embalagem, em centímetros.
	 * @param altura
	 *            A altura da embalagem, em centímetros.
	 * @param profundidade
	 *            A profundidade, ou comprimento da embalagem, em centímetros.
	 * @param peso
	 *            O peso deve ser informado em Kilogramas.
